    ...
    if (({ 
        ...
        if (({ 
            ...
            while (1) {
                ...
                printf("%s\n", bunker_str_add_int(BNK_RT_Strings_concat(NULL, BNK_RT_Strings_concat(NULL, BNK_RT_Strings_concat(NULL, bunker_str_add_int("DEBUG: Lookahead peek offset=", offset), " val="), ((Token*)tS)->value), " depth="), depth));
                if (({ 
                    strcmp(((Token*)tS)->type, "EOF") == 0 || strcmp(((Token*)tS)->value, ";") == 0 || strcmp(((Token*)tS)->value, ".") == 0 || strcmp(((Token*)tS)->value, "then") == 0;
                })) {
                    printf("%s\n", BNK_RT_Strings_concat(NULL, "DEBUG: Termination token found: ", ((Token*)tS)->value));
                    break;
                }
                if (({ 
                ...
                if (({ 
                    ...
                    if (({ 
                        ...
                        if (({ 
                            strcmp(((Token*)tNext)->value, ":") == 0 || strcmp(((Token*)tNext)->value, "<-") == 0;
                        })) {
                            foundColon = true;
                        }
                        break;
